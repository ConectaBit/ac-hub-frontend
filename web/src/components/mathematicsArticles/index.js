...
function MathematicsArticles(props) {
  const FETCH_BIA_MATHEMATICS= gql`
    query bia($start: Int!) {
      mathematics(start: $start) {
        data
        titulo
        link
        autores
  ...
  `;
  const { loading, data } = useQuery(FETCH_BIA_MATHEMATICS, {
